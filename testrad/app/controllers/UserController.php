...
class UserController extends BaseController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		$fields = array('id', 'name', 'email', 'passwoord', 'photo');
		...
		if(!empty($this->search)){
			...
			$db->orWhere('passwoord',"%$text%",'LIKE');
	...
	function add(){
		if(is_post_request()){
			...
			$db = $this->GetModel();
			$tablename = $this->tablename = 'user';
			$fields = $this->fields = array('name','email','passwoord','photo'); //insert fields
	...
	function edit($rec_id = null){
		...
		$this->rec_id = $rec_id;
		$tablename = $this->tablename = 'user';
		$fields = $this->fields = array('id','name','email','passwoord','photo'); //editable fields
		if(is_post_request()){
			Csrf :: cross_check();
			$postdata = $this->transform_request_data($_POST);
			$this->rules_array = array(
