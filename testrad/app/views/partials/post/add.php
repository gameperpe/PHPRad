                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                ...
                                                <textarea placeholder="Enter Headline" id="ctrl-headline"  required="" rows="" name="headline" class=" form-control"><?php  echo $this->set_field_value('headline',''); ?></textarea>
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                ...
                                                <select required=""  id="ctrl-title" name="title"  placeholder="Select a value ..."    class="custom-select" >
                                                    ...
                                                    $selected = $this->set_field_selected('title',$val[0], '');
                                                    ?>
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                ...
                                                <select required=""  id="ctrl-content" name="content"  placeholder="Select a value ..."    class="custom-select" >
                                                    ...
                                                    $val = array_values($arr);
                                                    $selected = $this->set_field_selected('content',$val[0], '');
                                                    ?>
                                                    <option <?php echo $selected; ?> value="<?php echo $val[0]; ?>">
                                                        <?php echo (!empty($val[1]) ? $val[1] : $val[0]); ?>
                                                    </option>
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                ...
                                                <select required=""  id="ctrl-status" name="status"  placeholder="Select a value ..."    class="custom-select" >
                                                    ...
                                                    $val = array_values($arr);
                                                    $selected = $this->set_field_selected('status',$val[0], '');
                                                    ?>
                                                    <option <?php echo $selected; ?> value="<?php echo $val[0]; ?>">
                                                        <?php echo (!empty($val[1]) ? $val[1] : $val[0]); ?>
                                                    </option>
